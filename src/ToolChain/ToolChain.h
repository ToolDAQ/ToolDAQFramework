...
class ToolChain{
 ...
 public:
  ...
  ToolChain(int verbose=1, int errorlevel=0, std::string service="test", std::string logmode="Interactive", std::string log_local_path="./log",  std::string log_service="", int log_port=0, int pub_sec=5, int kick_sec=60, unisgned int IO_Threads=1); 
