...
\begin{DoxyCompactItemize}
\item 
\hypertarget{classStore_a4305f269960e8ccc92b19b2f0480b16d}{class {\bfseries boost\-::serialization\-::access}}\label{classStore_a4305f269960e8ccc92b19b2f0480b16d}
...
Allows streaming of a flat J\-A\-S\-O\-N formatted string of \hyperlink{classStore}{Store} contents. \hypertarget{classStore_abe9b65d1308c43dc4158b00d6aed7385}{\index{Store@{Store}!operator$>$$>$@{operator$>$$>$}}
\index{operator$>$$>$@{operator$>$$>$}!Store@{Store}}
\subsubsection[{operator$>$$>$}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T $>$ void Store\-::operator$>$$>$ (
\begin{DoxyParamCaption}
\item[{T \&}]{obj}
...
\end{DoxyReturn}
\hypertarget{classStore_a790ca02bc7d11648edf0c8d5df3751fe}{\index{Store@{Store}!operator\mbox{[}$\,$\mbox{]}@{operator[]}}
\index{operator\mbox{[}$\,$\mbox{]}@{operator[]}!Store@{Store}}
\subsubsection[{operator[]}]{\setlength{\rightskip}{0pt plus 5cm}std\-::string$\ast$ Store\-::operator\mbox{[}$\,$\mbox{]} (
\begin{DoxyParamCaption}
\item[{std\-::string}]{key}
